...
/// Buffer types
pub const BufferType = enum { array, elementarray };

/// Draw types
pub const DrawType = enum { static, dynamic, stream };
...
/// Shader types
pub const ShaderType = enum { vertex, fragment, geometry };
...
/// Sets the glfw opengl profile
pub fn setProfile() void {
...
pub fn shaderCompile(alloc: *std.mem.Allocator, source: []const u8, comptime typ: ShaderType) Error!u32 {
...
pub fn shaderProgramCreate(alloc: *std.mem.Allocator, vertex: []const u8, fragment: []const u8) Error!u32 {
